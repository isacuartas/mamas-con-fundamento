...
function Chapter0() {
    return (
        <div className="chapter-content">
            ...
            <p>Llegó diciembre y me permití mucha flexibilidad. Disfruté de la pizza, los buñuelos y las galletas de la época. Pero cuando llegué al control médico en enero, la báscula marcó un salto de 58 a 62 kilos. El médico, cumpliendo con su protocolo, me advirtió: "Ojo, que no se trata de subir cuatro kilos por mes".</p>
            <p>En ese momento, mi mente de ingeniera se activó. No fue que el médico no supiera hacer su trabajo, sino que la consulta es tan rápida que no hay espacio para la profundidad. Me quedé con un aviso, pero sin la claridad técnica de qué estaba pasando en mi bioquímica. Ahí fue donde nació mi verdadero interés por la nutrición gestacional. Quería entender el "porqué" de cada proceso, más allá de los mitos que nuestras abuelas nos repiten con todo el amor del mundo, pero que a veces carecen de sustento real.</p>
            <p>Empecé a investigar para separar el cariño de la ciencia. Entendí que no se trata de obsesionarse con el peso, sino de tener datos claros para tomar decisiones.</p>
            <p>Hoy, en mi semana 28, me siento bien y fuerte. He aprendido que estar embarazada es comprender la química de tu propio cuerpo y encontrar el equilibrio entre un antojo y la estabilidad metabólica. Escribo esto para que tú también tengas esa claridad y ese fundamento que nos permite disfrutar el proceso sin miedos innecesarios.</p>
        </div>
    );
}

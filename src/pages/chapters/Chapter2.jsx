...
function Chapter2() {
    return (
        <div className="chapter-content">
            ...
            <p>Durante el embarazo, tu volumen de sangre aumenta aproximadamente un 50%. Necesitas esa sangre extra para irrigar la placenta y para que el líquido amniótico se renueve constantemente.</p>
            <ul>
            ...
            <h3>Pilar 2: Gestión de la Motilidad Gastrointestinal</h3>
            ...
            <h3>Pilar 3: El Hierro y la Logística del Oxígeno</h3>
            ...
            <ul>
                ...
                <li><strong>En la Práctica:</strong>
                    <ul>
                        <li><strong>Potencia:</strong> Acompaña el hierro con Vitamina C (guayaba, kiwi, cítricos). Solo 75 mg de Vitamina C pueden triplicar la absorción.</li>
                        <li><strong>Separa:</strong> El café, el té y los lácteos bloquean el hierro. Espera al menos 2 horas después de almorzar para consumirlos.</li>
                    </ul>
                </li>
            </ul>

            <h3>Pilar 4: Estabilidad Glucémica y Energía Cerebral</h3>
            ...
            <h3>Pilar 5: Calcio y Vitamina D (La regla en Colombia)</h3>
            ...
            <h3>Pilar 6: Proteínas (Tus ladrillos estructurales)</h3>
            ...
            <h3>Pilar 7: Grasas Saludables y Saciedad</h3>
            <p>Las grasas de calidad son el material de construcción del sistema nervioso.</p>
            <ul>
                <li><strong>El Fundamento:</strong> Las grasas ayudan a la absorción de vitaminas (A, D, E, K) y te mantienen satisfecha por más tiempo.</li>
                <li><strong>En la Práctica:</strong> Prioriza el aguacate, aceite de oliva y nueces. Nota: Dedicaremos el siguiente capítulo exclusivamente al DHA (Omega-3).</li>
            </ul>

            <h3>Pilar 8: Magnesio y Gestión del Descanso</h3>
            <p>El cuerpo consume magnesio más rápido debido al crecimiento del útero y al estrés físico del embarazo.</p>
            <ul>
                <li><strong>El Fundamento:</strong> El magnesio relaja los músculos y el sistema nervioso. Su déficit se traduce en calambres nocturnos e insomnio.</li>
                <li><strong>En la Práctica:</strong> Incluye semillas de calabaza, almendras y vegetales de hoja verde oscura para un descanso más profundo.</li>
            </ul>

            <h3>Pilar 9: El Equilibrio de Líquidos (Sodio y Potasio)</h3>
            ...
            <h3>Pilar 10: Seguridad Alimentaria (Tu escudo de protección)</h3>
            <p>Tu sistema inmune trabaja diferente ahora; debes ser más precavida con los riesgos biológicos.</p>
            <ul>
                <li><strong>El Fundamento:</strong> Bacterias como la Listeria o el Toxoplasma pueden atravesar la placenta.</li>
                <li><strong>En la Práctica:</strong> Todo bien cocido (nada de términos medios), vegetales desinfectados, evita quesos artesanales no pasteurizados y limita la cafeína a menos de 200 mg/día (2 tazas pequeñas).</li>
            </ul>
        </div>
    );
}
